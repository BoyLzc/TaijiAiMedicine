...
public class EmbeddingTest {
    ...
    public void embeddingSearch() {
        ...
        // 从匹配项列表中获取第一个匹配项
        EmbeddingMatch<TextSegment> textSegmentEmbeddingMatch = result.matches().get(0);
...
/*        // 从匹配项列表中获取所有结果
        ...
        for (int i = 0; i < matches.size(); i++) {
            ...
            System.out.println("第 " + i + " 个结果的相似度得分: " + match.score());
            System.out.println("匹配的文本: " + match.embedded().text());
        }*/
    }

    @Test
    public void xiaozhiEmbeddingStore() {
